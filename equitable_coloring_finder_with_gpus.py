...
TIMEOUT_PER_CONFIGURATION = 3 * 60  # 10 minutes
...
def visualize_and_save_graph(n, s, p, b, edge_colors, output_dir, count):
    ...
    print(f"    Saved graph visualization as {filepath_png}")
